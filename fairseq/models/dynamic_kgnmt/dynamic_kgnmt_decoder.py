...
class KGNMTDecoderBase(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        if knw_encoder_out is not None and len(knw_encoder_out["encoder_out"]) > 0:
            knw_enc = knw_encoder_out["encoder_out"][0]
        if knw_encoder_out is not None and len(knw_encoder_out["encoder_padding_mask"]) > 0:
            knw_padding_mask = knw_encoder_out["encoder_padding_mask"][0]
        ...
        for idx, layer in enumerate(self.layers):
            ...
            ### TODO: handle decoder layer accept knw_enc
    ...
    # TODO: Maybe we want to discover about this, in case we use this function
    def upgrade_state_dict_named(self, state_dict, name):
        ...
        # TODO: what's here too
        for i in range(self.num_layers):
            # update layer norms
            layer_norm_map = {
                "0": "self_attn_layer_norm",
                "1": "encoder_attn_layer_norm",
                "2": "knw_attn_layer_norm",
                "3": "final_layer_norm",
            }
