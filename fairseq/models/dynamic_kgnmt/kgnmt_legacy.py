...
@register_model("kgnmt")
class KgNMTModel(KgNMTModelBase):
    """
    ...
    def build_model(cls, args, task):
        ...
        if getattr(args, "max_knowledge_positions", None) is None:
            args.max_knowledge_positions = DEFAULT_MAX_KNOWLEDGE_POSITIONS
...
@register_model_architecture("kgnmt", "kgnmt_tiny")
...
@register_model_architecture("kgnmt", "kgnmt")
...
# @register_model_architecture("kgnmt", "kgnmt_iwslt_de_en")
# def kgnmt_iwslt_de_en(args):
#     args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
...
@register_model_architecture("kgnmt", "kgnmt_iwslt_vi_en")
def kgnmt_iwslt_vi_en(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 1024)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 4)
    args.encoder_layers = getattr(args, "encoder_layers", 6)
...
@register_model_architecture("kgnmt", "kgnmt_wmt_en_vi")
def kgnmt_wmt_en_vi(args):
    base_architecture(args)
