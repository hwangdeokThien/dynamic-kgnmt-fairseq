...
def collate(
    ...
    # TODO_THESIS: we make the source input and the knowledge correspond like source and target
...
# TODO_THESIS: modify this class to support knowledge augmentation
class LanguagePairKnowledgeAugDataset(FairseqDataset):
    """
    ...
    Args:
        ...
        knw (torch.utils.data.Dataset, optional): knowledge dataset to wrap
        knw_sizes (List[int], optional): knowledge sentence lengths
        knw_dict (~fairseq.data.Dictionary, optional): knowledge vocabulary
